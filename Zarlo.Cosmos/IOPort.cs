...
public class OIOPort
{
    ...
    public void Write8(byte aData) => PORT.Write8(_port, aData);
    ...
    /// <param name="aData">A data.</param>
    public void Write16(ushort aData) => PORT.Write16(_port, aData);
    ...
    /// </summary>
    /// <param name="aData">A data.</param>
    public void Write32(uint aData) => PORT.Write32(_port, aData);

    /// <summary>
    /// Read byte from port.
    /// </summary>
    /// <returns>byte value.</returns>
    public byte Read8() => PORT.Read8(_port);

    /// <summary>
    /// Read Word from port.
    /// </summary>
    /// <returns>ushort value.</returns>
    public ushort Read16() => PORT.Read16(_port);

    /// <summary>
    /// Read DWord from port.
    /// </summary>
    /// <returns>uint value.</returns>
    public uint Read32() => PORT.Read32(_port);
    ...
    public void Read8(byte[] aData) => PORT.Read8(_port, aData);

    /// <summary>Read Word from base port.</summary>
    /// <param name="aData">Output data array.</param>
    /// <exception cref="T:System.OverflowException">Thrown if aData lenght is greater than Int32.MaxValue.</exception>
    public void Read16(ushort[] aData) => PORT.Read16(_port, aData);
