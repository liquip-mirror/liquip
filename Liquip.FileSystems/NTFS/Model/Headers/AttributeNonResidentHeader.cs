...
namespace Liquip.FileSystems.NTFS.Model.Headers;
...
public class AttributeNonResidentHeader : ISaveableObject
{
    ...
    {
        var size = ContentSizeCompressed != 0 ? 56 : 48;
    ...
    public void Save(byte[] buffer, int offset)
    {
        ...
        if (Fragments != null)
        {
            var pointer = ContentSizeCompressed != 0 ? 56 : 48;
    ...
    public static AttributeNonResidentHeader ParseHeader(byte[] data, int offset = 0)
    {
        ...
        var res = new AttributeNonResidentHeader();
