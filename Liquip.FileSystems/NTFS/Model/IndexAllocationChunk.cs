...
public class IndexAllocationChunk
{
    ...
    public static bool IsIndexAllocationChunk(byte[] data, int offset)
    {
        ...
        var signature = Encoding.ASCII.GetString(data, offset + 0, 4);
    ...
    public static IndexAllocationChunk ParseBody(Ntfs ntfsInfo, byte[] data, int offset)
    {
        ...
        var res = new IndexAllocationChunk();
        ...
        NtfsUtils.ApplyUSNPatch(data, offset, (res.SizeOfIndexAllocated + 24) / ntfsInfo.BytesPerSector,
            ntfsInfo.BytesPerSector, res.USNNumber, res.USNData);
        ...
        var pointer = offset + (int)(res.OffsetToFirstIndex + 24); // Offset is relative to 0x18
