...
public class Utils
{
    public static byte ModR_M(Mod mod, Reg reg, Rm rm)
    {
        return (byte)((byte)mod | (byte)reg | (byte)rm);
    }
    ...
    public static byte SIB(ScaleFactor scale, Reg index, Reg _base)
    {
        return (byte)((byte)scale | (byte)index | (byte)_base);
    }
