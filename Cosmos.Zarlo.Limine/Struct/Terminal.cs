...
public struct TerminalRequest
{
    ...
    [MarshalAs(UnmanagedType.LPStruct)] public TerminalResponce response;
...
public struct TerminalResponce
{
    ...
    [MarshalAs(UnmanagedType.LPStruct)] public LimineTerminal[] terminals;
...
public struct LimineTerminal
{
    ...
    public ulong rows;
    [MarshalAs(UnmanagedType.LPStruct)] public Framebuffer framebuffer;
}