...
using Attribute = Zarlo.Cosmos.FileSystems.NTFS.Model.Attributes.Attribute;
...
public class FileRecord
{
    ...
    private void ParseAttributes(byte[] data, uint maxLength, int offset)
    {
        ...
        {
            var attributeType = Attribute.GetType(data, attribOffset);
            ...
            var attrib = Attribute.ParseSingleAttribute(data, (int)length, attribOffset);
